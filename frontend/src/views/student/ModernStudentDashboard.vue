    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          ...
          <button @click="browsePhysicalLibrary" class="p-4 bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all group">
            <div class="p-3 bg-teal-100 rounded-lg mb-3 group-hover:bg-teal-200 transition-colors">
              <svg class="w-6 h-6 text-teal-600 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <div class="text-sm font-medium text-gray-900">Physical Library</div>
          </button>
...
const browsePhysicalLibrary = () => router.push('/student/physical-library')
